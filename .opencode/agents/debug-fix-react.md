---
name: debug-fix-react
description: Diagnose and apply a minimal fix in Fintory React/Mantine code. Use for concrete bugs, errors, regressions, CSV import issues, SQLite issues, or Electron issues.
mode: primary
...
4. Load Fintory/domain/platform/data/React skills as needed.
